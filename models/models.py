...
def get_unet2(n_classes):
    return Unet2(feature_scale=1, n_classes=n_classes, in_channels=4, is_deconv=True, is_batchnorm=False)

def get_fcn(num_output_classes=11):
    return FCN(num_input_channels=4, num_output_classes=num_output_classes, num_filters=64)