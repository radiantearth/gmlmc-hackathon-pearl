...
class StreamingGeospatialDataset(IterableDataset):
    ...
    def __init__(self, imagery_fns, label_fns=None, groups=None, chip_size=256, num_chips_per_tile=200, windowed_sampling=False, image_transform=None, label_transform=None, nodata_check=None, verbose=True):
    ...
    def stream_chips(self):
        for img_fn, label_fn, group in self.stream_tile_fns():
            ...
            print ('label shape: ', label_fp.shape)
            print ('label height: ', label_fp.shape[0])
            print ('label width: ', label_fp.shape[1])
